...
var X13 = {
  ...
  RegisterView: function (fName, obj, val) {
    var idx = fName.lastIndexOf("/");
    var name = idx >= 0 ? fName.substr(idx + 1) : fName;
    var t= Object.create(X13.conn.TopicOr, { _conn: { value: X13.conn, writable: false, enumerable: false }, name: { value: name } })
    t.value = val || { "$schema": "view", "code": "", "icon": "\dt_icons\object.png" };
    t.view = React.createClass(obj);
    X13.conn._views[fName] = t;
  },
  conn: {
    _socket: null,
    _root: null,
    ...
    handleConnect: function () {
      ...
      var tmp = X13.GetTopic("/etc/schema", 2, this.handleSchemaViewChild.bind(this));
      tmp = X13.GetTopic("/etc/UI", 2, this.handleSchemaViewChild.bind(this));
    },
